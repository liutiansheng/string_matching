////////////////////////////////////////////////////////////////////////////////
// Shift-And string matching algorithm using bitwise operation
//
...
////////////////////////////////////////////////////////////////////////////////
// Usage:
// > g++ -o shift_and shift_and.cpp
// > ./shift_and
// > 2
// or
// > ./shift_and <own-defined pattern> <own-defined text>
////////////////////////////////////////////////////////////////////////////////
#include <iostream>
#include <vector>
#include <map>
...
///
/// @brief find the first index of @a pattern in string @a text using Shift-And string matching
/// @retval -1 if not found
/// @retval >= 0 if found
/// 
int shift_and_match(char *pattern, char *text)
{
  ...
  for (int n = 0; text[n] != '\0'; ++n) {
    ...
    transform(D.begin(), D.end(), b->begin(), D.begin(), logical_and<bool>());
    if (D[M-1])
      return n - M + 1;
  }
  return not_found;
